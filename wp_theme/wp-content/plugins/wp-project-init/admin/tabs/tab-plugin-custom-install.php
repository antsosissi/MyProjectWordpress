...
<div class="wpi-notif" style="padding-left: 10px;">
    <p>
        Activer les plugins custom pour votre projet si besoin.
    </p>
</div>
...
<form class="wpi-form  wpi-form<?php echo rand(1,12);?>" method="post" action="" enctype="multipart/form-data">
    <?php global $wppi_plugins_custom;
    $plugins_to_active = array();
    ?>

    <?php foreach ( $wppi_plugins_custom as $categorie => $plugins): ?>
      <table class="form-table oddeven">
        <tbody>
          <tr class="head">
            <th colspan="5" scope="row"><?php echo $categorie;?></th>
          </tr>
          <?php foreach ( $plugins as $plugin ):
            ...
            $name = $plugin;
              ...
              $data = get_plugin_data( WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . $plugin_path );
          ...
          <tr>
            ...
            <td>V<?php echo $data['Version'];?></td>
            <td><?php echo $data['Description'];?></td>
            <td>By <?php echo $data['Author'];?></td>
            <td>
              <?php
