    ...
    switch ( $comment->comment_type ) :
      ...
      case 'trackback' :
        ...
        <li class="post pingback">
          <p><?php _e( 'Pingback:', 'theme' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( 'Edit', 'theme' ), '<span class="edit-link">', '</span>' ); ?></p></li>
        <?php
        break;
      default :
        ?>
          ...
          <article id="comment-<?php comment_ID(); ?>" class="comment">
            <footer class="comment-meta">
              <div class="comment-author vcard">
                ...
                <?php edit_comment_link( __( 'Edit', 'theme' ), '<span class="edit-link">', '</span>' ); ?>
            ...
            <div class="reply">
              <?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply <span>&darr;</span>', 'theme' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
            </div><!-- .reply -->
          </article><!-- #comment-## -->
        </li>
        <?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * See theme_comment() in theme/functions.php for more.
				 */
