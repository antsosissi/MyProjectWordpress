(function($) {
    $(document).ready(function() {
        ...
        function bondy_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    bondy_remove_file($(this).parents('.section'));
                });
            });
        ...
        function bondy_remove_file(selector) {
            ...
            selector.find('.upload-button').live('click', function() {
                bondy_add_file(event, $(this).parents('.section'));
            });
        }
