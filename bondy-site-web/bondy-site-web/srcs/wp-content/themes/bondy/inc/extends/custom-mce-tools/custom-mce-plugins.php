...
add_filter("mce_external_plugins", "bondy_add_tinymce_plugin");
function bondy_add_tinymce_plugin( $plugin_array ){
...
add_filter('mce_buttons', "bondy_register_tinymce_button");
function bondy_register_tinymce_button($buttons) {
