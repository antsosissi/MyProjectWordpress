...
function wp_get_custom_posts_capabilities( $capability_type, $is_taxo = false ){
  if ( $is_taxo ){
    ...
    $caps =  array(
      "edit_post"                   => "edit_{$capability_type}s",
      "edit_private_posts"          => "edit_private_{$capability_type}s",
      "edit_published_posts"        => "edit_published_{$capability_type}s",
      "delete_post"                 => "delete_{$capability_type}s",
...
/*chnage url connexion admin*/
// Modifier l'URL du logo de connexion sur la page d'administration

add_filter( 'login_headerurl', 'bondy_login_url' );
function bondy_login_url($url) {
    $url = get_home_url();
    return $url;
}


function bondy_image_resize($url, $width, $height = null, $crop = null, $single = true) {
