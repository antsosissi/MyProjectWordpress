...
class jpress_gallery_api{
	/**
	* fonction pour verifier si site mobile ou non
	* @return	boolean  
	**/	 	 
	static function isMobile($ipadIsMobile = false) {
		...
		foreach ($mobile_agents as $device) {
			...
			if (stristr($user_agent, $device) && !$ipadIsMobile && !stristr($user_agent, 'ipad')){
					$is_mobile = true;
					...
					break;
			}else if(stristr($user_agent, $device) && $ipadIsMobile){
					$is_mobile = true;
